...
from tensorflow.keras import Input, Model, Sequential, callbacks
...
dataset = text_dataset_from_directory(directory="../data/aclImdb", label_mode=None, batch_size=256)
